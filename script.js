// URLs das planilhas
const PLANILHA_ESTABELECIMENTO = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vReHS_9ZXavgCKZ0IM5i_usNwcnvPDn3mORV8A-VmGgnMa4_K-Ywjz9rcFuJfR7-Wm6ahiwfKIQlb10/pub?gid=0&single=true&output=csv';
const PLANILHA_CATEGORIAS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vT8TCQ0osQx1YsiIlZu17KCbi5aVG4a_1kcghIOKHk1Mr-rlSgPXYgiIe9HnFiOjMjXiF5mD7HNTrl9/pub?gid=212437501&single=true&output=csv';
const PLANILHA_ITENS = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vReHS_9ZXavgCKZ0IM5i_usNwcnvPDn3mORV8A-VmGgnMa4_K-Ywjz9rcFuJfR7-Wm6ahiwfKIQlb10/pub?gid=1327193985&single=true&output=csv';
...
function desabilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        if (!botao.disabled) {
            botao.disabled = true;
            botao.classList.remove('bg-blue-500', 'hover:bg-blue-600');
...
function habilitarBotoesAdicionar() {
    ...
    botoes.forEach(botao => {
        ...
        if (item && (item.disponivel === 'TRUE' || item.disponivel === true || item.disponivel === 'true')) {
            ...
            botao.classList.add('bg-blue-500', 'text-white', 'hover:bg-blue-600');
